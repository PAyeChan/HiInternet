...
class CheckCreateUserBloc extends BaseNetwork {
  ...
  Stream<ResponseVO> checkCreateUserStream() => checkCreateUserController.stream;
      ...
      if (value != null) {
        postReq(SERVICE_CREATE_USER_URL, token: json.decode(value), params: map,
          ...
          if (resp.data['status'] == 'Success') {
            ...
            print(createUserResponseVO.checkCreateduser);

            resp = ResponseVO(message: MsgState.success);
          }
